...
#dgeom(x,p)
#dbinom(x,n,p) incercari independente (nu e stabilit nr de incercari)
#Ce inseamna?
dbinom(3,5,0.4) #Probabilitatea sa reusesc de 3 ori din 5 incercari cu probabilitatea de succes de 0.4
#P(X=3)
# pt variabila aleatoare in loc sa numar incercarile pana la succes, le numar pe cele pana la esec
dbinom(0:5,5,0.4)
...
#dexp(x,lambda) repartitia exponentiala (timp de asteptare pana la producerea primului eveniment)
...
#sunt parametrii repartitiei, pusi in ordine
 ...
 #  rbinom(nr,n,p)
   ...
   set.seed(15129)# pozitia e aleatoare, nu si seed-ul (simularea valorii)
